...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='9'";
...
if ($status == 1) {
...
else if ($data_server1['npk'] == '01896' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.11.30') {
...
else if ($data_server1['npk'] == 'P1064' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.11.30') {
   ...
   header("Refresh: 300;url='ping_dev_absen1.php'");
?>