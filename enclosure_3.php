...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='6'";
...
else if ($data_server1['npk'] == '01563' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.31') {
...
else if ($data_server1['npk'] == '01314' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.31') {
...
else if ($data_server1['npk'] == 'P1074' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.31') {
...
else if ($data_server1['npk'] == '01934' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.31') {
