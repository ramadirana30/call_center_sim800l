...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='10'";
...
if ($status == 1) {
    ...
    if(empty($data_server1['ip_address']) || $data_server1['follow_up'] == '1' && $data_server1['nt'] == '1' && $data_server1['rs'] == '1' || $data_server1['follow_up'] == '0' && $data_server1['npk'] == 'P1064'){


        $karyawan = "SELECT npk, no_hp, sequence FROM pic_server WHERE npk = '01896'";
...
else if ($data_server1['npk'] == '01896' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.11.31') {

    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server WHERE npk = 'P1064'";
        $result_k = mysqli_query($conn, $karyawan);
        $data_karyawan = mysqli_fetch_array($result_k);
...
else if ($data_server1['npk'] == 'P1064' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.11.31') {
    
    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server npk = '01896'";
    $result_k = mysqli_query($conn, $karyawan);
    $data_karyawan = mysqli_fetch_array($result_k);
   ...
   header("Refresh: 300;url='ping_dev_absen2.php'");
?>