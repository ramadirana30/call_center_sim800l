...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='3'";
...
if ($status == 1) {
    ...
    if(empty($data_server1['ip_address']) || $data_server1['follow_up'] == '1' && $data_server1['nt'] == '1' && $data_server1['rs'] == '1' || $data_server1['follow_up'] == '0' && $data_server1['npk'] == '01934'){
        ...
        $karyawan = "SELECT npk, no_hp, sequence FROM pic_server WHERE npk = '01564'";
...
else if ($data_server1['npk'] == '01564' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.3') {

    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server WHERE npk = 'P1063'";
        $result_k = mysqli_query($conn, $karyawan);
        $data_karyawan = mysqli_fetch_array($result_k);
...
else if ($data_server1['npk'] == 'P1063' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.3') {

    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server WHERE npk = 'P1066'";
        $result_k = mysqli_query($conn, $karyawan);
        $data_karyawan = mysqli_fetch_array($result_k);
...
else if ($data_server1['npk'] == 'P1066' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.3') {
...
else if ($data_server1['npk'] == '01934' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.3') {
    
    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server npk = '01564'";
    $result_k = mysqli_query($conn, $karyawan);
    $data_karyawan = mysqli_fetch_array($result_k);
...
//header("Refresh: 300;url='ping_baan.php'");
