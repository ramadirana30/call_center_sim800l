...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='4'";
...
else if ($data_server1['npk'] == '01563' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.28') {
...
else if ($data_server1['npk'] == '01314' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.28') {
...
else if ($data_server1['npk'] == 'P1074' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.28') {
...
else if ($data_server1['npk'] == '01934' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.10.28') {
...
//header("Refresh: 300;url='enclosure_1.php'");
