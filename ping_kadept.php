...
$ipserver = "SELECT ip_address,server FROM ip_server_kybi WHERE id_server='8'";
...
else if ($data_server1['npk'] == 'P1066' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.8.81') {
...
else if ($data_server1['npk'] == '01934' && $data_server1['follow_up'] == 0 && $data_server1['ip_address'] == '192.168.8.81') {
    
    $karyawan = "SELECT npk, no_hp, sequence FROM pic_server npk = 'P1066'";
    $result_k = mysqli_query($conn, $karyawan);
    $data_karyawan = mysqli_fetch_array($result_k);
